...
$url        = 'https://github.com/buddhi1980/mandelbulber2/releases/download/2.26/Mandelbulber2-v2.26.0.0-Setup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'Mandelbulber2*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
